...
- `GuzzleHttp\Query` and `GuzzleHttp\Querygm_highload` have been removed. Query
...
The `Guzzle\gm_highload` namespace has been removed. This was previously used to
make it possible to plug in custom gm_highloads for cookies, messages, URI
