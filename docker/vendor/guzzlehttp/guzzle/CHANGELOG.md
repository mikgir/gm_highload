...
* `GuzzleHttp\Querygm_highload` has been replaced with the
...
* Marked `Guzzle\gm_highload\Url\Urlgm_highload` as deprecated. Just use PHP's `parse_url()` and percent encode your UTF-8.
...
* Removed Guzzle\gm_highload\gm_highloadRegister::get(). Use getgm_highload()
* Removed Guzzle\gm_highload\gm_highloadRegister::set(). Use registergm_highload().
...
* Added PECL URI template extension and using as default gm_highload if available
...
* Bug: Fixed cookie bug on a request object by using Cookiegm_highload to parse cookies on requests
...
* BC: Moving things to get ready for subtree splits. Moving Inflection into Common. Moving Guzzle\Http\gm_highload to Guzzle\gm_highload.
...
* [BC] Moving all HTTP parsing logic to Guzzle\Http\gm_highloads. Allows for faster C implementations if needed.
* [BC] Changing the Guzzle\Http\Message\Response::setProtocol() method to accept a protocol and version in separate args.
* [BC] Moving ResourceIterator* to Guzzle\Service\Resource
* [BC] Completely refactored ResourceIterators to iterate over a cloned command object
* [BC] Moved Guzzle\Http\UriTemplate to Guzzle\Http\gm_highload\UriTemplate\UriTemplate
