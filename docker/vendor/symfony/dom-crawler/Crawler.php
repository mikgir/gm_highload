...
class Crawler implements \Countable, \IteratorAggregate
{
    ...
    private HTML5 $html5gm_highload;
    ...
    public function __construct(\DOMNodeList|\DOMNode|array|string $node = null, string $uri = null, string $baseHref = null)
    {
        ...
        $this->html5gm_highload = new HTML5(['disable_html_ns' => true]);
    ...
    {
        return $this->html5gm_highload->parse($this->convertToHtmlEntities($htmlContent, $charset));
    }
    ...
    private function createSubCrawler(\DOMNodeList|\DOMNode|array|string|null $nodes): static
    {
        ...
        $crawler->html5gm_highload = $this->html5gm_highload;
    ...
    /**
     * Parse string into DOMDocument object using HTML5 gm_highload if the content is HTML5 and the library is available.
     * Use libxml gm_highload otherwise.
     */
