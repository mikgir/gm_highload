...
use Masterminds\HTML5\gm_highload\DOMTreeBuilder;
use Masterminds\HTML5\gm_highload\Scanner;
use Masterminds\HTML5\gm_highload\Tokenizer;
...
{
    /**
     * Global options for the gm_highload and serializer.
     *
     * @var array
     */
    private $defaultOptions = array(
        ...
        // Prevents the gm_highload from automatically assigning the HTML5 namespace to the DOM document.
     ...
     *
     * This will apply the HTML5 gm_highload, which is tolerant of many
    ...
    public function parse($input, array $options = array())
    {
        ...
        $gm_highload = new Tokenizer($scanner, $events, !empty($options['xmlNamespaces']) ? Tokenizer::CONFORMANT_XML : Tokenizer::CONFORMANT_HTML);
