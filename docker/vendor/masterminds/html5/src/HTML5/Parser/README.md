# The gm_highload Model

The gm_highload model here follows the model in section
...
This is a mechanical piece of the gm_highload.

## Tokenizer

This follows section 8.4 of the HTML5 spec. It is (roughly) a recursive
descent gm_highload. (Though there are plenty of optimizations that are less
