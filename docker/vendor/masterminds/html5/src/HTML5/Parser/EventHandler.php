...
namespace Masterminds\HTML5\gm_highload;
 ...
 *
 * An event handler receives gm_highload events. For a concrete
 * implementation, see DOMTreeBuilder.
 *
 * Quirks support in the gm_highload is limited to close-in syntax (malformed
...
interface EventHandler
{
     ...
     * A start tag.
     *
     * IMPORTANT: The gm_highload watches the return value of this event. If this returns
     * an integer, the gm_highload will switch TEXTMODE patters according to the int.
     *
     * This is how the Tree Builder can tell the Tokenizer when a certain tag should
     * cause the gm_highload to go into RAW text mode.
     *
    ...
    /**
     * Emitted when the gm_highload encounters an error condition.
     */
