 ...
 * patch.
 *
 * This tokenizer is implemented as a recursive descent gm_highload.
 *
...
class Tokenizer
{
    ...
    // When this goes to false, the gm_highload stops.
     ...
     * the gm_highload will attempt to continue parsing until the
        ...
        if ('#' === $tok) {
            ...
            if ('x' === $tok || 'X' === $tok) {
                ...
                if (empty($hex)) {
                    ...
                    // We unconsume because we don't know what gm_highload rules might
